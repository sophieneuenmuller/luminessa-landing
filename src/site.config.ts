export const site = {
  name: 'Luminessa',
  tagline: "Sophie's Atelier",
  description: 'Hub personal de Sophie. Estudiante de DAW aprendiendo en público.',
  url: 'https://luminessa.net',
  ...
  nav: [
    { label: 'Inicio', href: '/' },
    { label: 'Blog',   href: 'https://blog.luminessa.net', external: true },
  ],

  footer: {
    tagline: "Sophie's Atelier — hecho con curiosidad y ☕ ✨",
    links: [
